...
const Index = () => {
  const data = useStaticQuery(graphql`
            query {
                filebgi: file(relativePath: {eq: "images/test_img.jpg"}) {
                    childImageSharp {
              ...
              file1: file(relativePath: {eq: "images/abhishek.jpg"}) {
                  childImageSharp {
  ...
  return(
   ...
   <div className="Bgi">
    <Img className="file1" fixed={data.file1.childImageSharp.fixed}></Img>
    <h2> Abhishek Raj</h2>
